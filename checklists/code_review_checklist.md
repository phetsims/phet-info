...
- [ ] All sims should use a color file named MyRepoColors.js or, if using abbreviations, MyRepoColors.js, and use 
  ...
  and https://github.com/phetsims/scenery-phet/issues/515
