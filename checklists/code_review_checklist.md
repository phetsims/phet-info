...
- [ ] Does each **new** common code user interface component that was developed to support this sim call `Tandem.validateOptions` immediately after the options are extended in the constructor?  See https://github.com/phetsims/phet-io/issues/77. If it is unclear which, if any, new common code components have been introduced for this sim, please contact the sim author(s).
