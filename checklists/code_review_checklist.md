...
- [ ] Is there a file in assets/ for every file in audio/ and images/? Note that there is not a 1:1 correspondence between file; for example, several images may be in the same .ai file. 
