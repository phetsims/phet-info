...
Other:
- [ ] Navigate to phettest.colorado.edu and click the "Refresh Perennial" button. (If you're off campus, VPN is required to access phettest.colorado.edu, see https://oit.colorado.edu/services/network-internet-services/vpn.)
