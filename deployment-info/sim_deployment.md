...
The latest SHAs under testing (use these if appropriate): http://www.colorado.edu/physics/phet/dev/html/gravity-and-orbits/1.1.0-rc.1/dependencies.json
...
* **PRODUCTION FOR PHET_IO_BRAND**:
   ...
   + Make sure that the current level of instrumentation is represented here in the [Instrumentation Status Spreadsheet](https://docs.google.com/spreadsheets/d/1pU9izdNQkd9vr8TvLAfXe_v68yh-7potH-y712FBPr8/edit#gid=0)
