...
* Following steps are for PhET brand only (not PhET-iO).  Instead for PhET-iO please test the deployed version, see below but don't forget to `grunt checkout-master` again
